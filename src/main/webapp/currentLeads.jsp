    ...
    <div class="leftPanel">
     ...
     <section class="maincontent">
        ...
        <div class="bottomPanel">
          ...
          <div class="prevButton <%= (start==0)?"disable":"" %>"><a href="currentLeads.jsp?pageNumber=<%= pageNo-1%>">Prev</a></div>
          <div class="nextButton <%= (dataCount+start>total)?"disable":"" %>"><a href="currentLeads.jsp?pageNumber=<%= pageNo+1%>">Next</a></div>
       </div>
